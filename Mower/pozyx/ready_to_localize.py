...
if __name__ == "__main__":
    ...
    remote_id = 0x672a               # remote device network ID
    ...
    anchors = [
               DeviceCoordinates(0x6716, 1, Coordinates(0, 0, 0)),
               DeviceCoordinates(0x676a, 1, Coordinates(250, 0, 800)),
               DeviceCoordinates(0x6721, 1, Coordinates(0, 0, 800)),
               DeviceCoordinates(0x6742, 1, Coordinates(250, 250, 0))]
